...
struct Statistics
{
	...
	enum value {
		...
		SEARCH_TEMP_SPACE, SECONDARY_HITS, ERASED_HITS, SQUARED_ERROR, CELLS, OUTRANKED_HITS, TARGET_HITS0, TARGET_HITS1, TARGET_HITS2, TARGET_HITS3, TARGET_HITS4, TIME_GREEDY_EXT, LOW_COMPLEXITY_SEEDS,

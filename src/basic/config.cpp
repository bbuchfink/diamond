...
("quiet", 0, "disable console output", quiet);
	...
	aligner.add()
		...
		("range-culling", 0, "delete hits only if higher scoring hits span the query range", query_range_culling)
		("range-cover", 0, "percentage of range to be covered for hit culling (default=50)", query_range_cover, 50.0)

**DIAMOND v0.7.6 by Benjamin Buchfink** - http://github.com/bbuchfink/diamond
...
If you use a recent **Linux** operating system, you can download the software in binary format for immediate use::
    ...
    wget http://github.com/bbuchfink/diamond/releases/download/v0.7.6/diamond-linux64.tar.gz
...
To compile DIAMOND from source, invoke the following commands on the shell::
    ...
    $ wget http://github.com/bbuchfink/diamond/archive/v0.7.6.tar.gz
    $ tar xzf v0.7.6.tar.gz
    $ cd diamond-0.7.6/src
    $ ./install-boost                                       # optional, for installing Boost
    $ make
    
The diamond binary will be created in ``diamond-0.7.6/bin``.

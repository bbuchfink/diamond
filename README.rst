**DIAMOND v0.8.4 by Benjamin Buchfink** - http://github.com/bbuchfink/diamond
...
If you use a recent **Linux** operating system, you can download the software in binary format for immediate use::
    ...
    wget http://github.com/bbuchfink/diamond/releases/download/v0.8.4/diamond-linux64.tar.gz
...
To compile DIAMOND from source, invoke the following commands on the shell::
  ...
  $ wget http://github.com/bbuchfink/diamond/archive/v0.8.4.tar.gz
